...
use App\Api\v2\ApiOrderPlanAsset;

class ApiOrderPlanAssetsController extends Controller {
	/**
	 * Get plan assets.
	 *
	...
	public function get(Request $request) {
		...
		$data = ApiOrderPlanAsset::get($params);
	...
	public function add(Request $request) {
		$item = ApiOrderPlanAsset::add($request->all());
	...
	public function save(Request $request) {
		...
		$item = ApiOrderPlanAsset::save($id, $params);
