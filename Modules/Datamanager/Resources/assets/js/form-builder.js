(function() {
    ...
    angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
        ...
        '$scope', '$injector', function($scope, $injector) {
            ...
            // @note Edited by @monkey_monk (forward to component.controller)
            if (typeof $scope.object.controller === 'function') {
                $scope.object.controller.call(this, $scope, $builder, $injector);
            }
        }
    ]);
...
(function() {
    ...
    angular.module('builder.provider', []).provider('$builder', function() {
        ...
        this.convertComponent = function(name, component) {
            var result, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _ref10, _ref11;
            result = {
                name: name,
        ...
        this.convertFormObject = function(name, formObject) {
            var component, exist, form, result, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _ref10, _ref11;
            if (formObject == null) {
                formObject = {};
            }
            ...
            result = {
                ...
                controller: (_ref11 = formObject.controller) != null ? _ref11 : component.controller
            };
            return result;
        };
