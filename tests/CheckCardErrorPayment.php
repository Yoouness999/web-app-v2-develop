 ...
 *
 * @comment php vendor/phpunit/phpunit/phpunit tests/CheckCardErrorPayment
 */
...
class CheckCardErrorPayment extends TestCase
{
    /**
     * Test the payment flow from Adyen for card with error response
     *
     * @scenario :
     *
