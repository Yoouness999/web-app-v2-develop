 ...
 *
 * @comment php vendor/phpunit/phpunit/phpunit tests/CheckSepaErrorPayment
 */
...
class CheckSepaErrorPayment extends TestCase
{
    /**
     * Test the payment flow from Adyen for sepadirect with error response
     *
     * @scenario :
     *
