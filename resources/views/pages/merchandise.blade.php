...
@section('content')
    ...
    <div id="businessCarousel" class="carousel slide animated fadeIn" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
            <div class="page-banner page-banner-lg">
                <img class="sr-only" src="{{ asset('assets/img/merchandise-header.jpg') }}" alt="Boxify merchandise storage service Banner">
                <div class="background-banner mobile" style="background-image: url({{ asset('assets/img/merchandise-header.jpg') }})"></div>
                <div class="background-banner desktop" style="background-image: url({{ asset('assets/img/merchandise-header.jpg') }})"></div>
                <div class="page-banner-content">
                    <h1><?= lg('merchandise.storage.page.header.title')?></h1>
                    <h2><?= lg('merchandise.storage.page.header.subtitle')?></h2>
                    <a class="btn btn-primary" href="#form-contact"><?= lg('merchandise.storage.page.header.button')?></a>
                </div>
            </div>
        </div>
    </div>
 ...
 <!-- stepper-advantage-section-merchandise -->
...
<section class="stepper-advantage-section-merchandise text-center">
  <div class="container black" style="display: flex; flex-direction: row; justify-content: space-between;">
    <div class="col-12 col-md-3 d-flex flex-column align-items-center">
      <div class="item">
        <p class="image">
          <img src="https://landen.imgix.net/uhtii1k9o5x3/assets/xuhnd2ap.png?w=48" alt="<?= lg('merchandise.storage.page.advantage.security')?>" />
        </p>
        <h3 class="title"><?= lg('merchandise.storage.page.advantage.security')?></h3>
      </div>
    </div>
    <div class="col-12 col-md-3 d-flex flex-column align-items-center">
      <div class="item">
        <p class="image">
          <img src="https://landen.imgix.net/uhtii1k9o5x3/assets/6d5fio4d.png?w=48" alt="<?= lg('merchandise.storage.page.advantage.capacity')?>" />
        </p>
        <h3 class="title"><?= lg('merchandise.storage.page.advantage.capacity')?></h3>
      </div>
    </div>
    <div class="col-12 col-md-3 d-flex flex-column align-items-center">
      <div class="item">
        <p class="image">
          <img src="https://landen.imgix.net/uhtii1k9o5x3/assets/t7e72zjw.png?w=48" alt="<?= lg('merchandise.storage.page.advantage.profit')?>" />
        </p>
        <h3 class="title"><?= lg('merchandise.storage.page.advantage.profit')?></h3>
      </div>
    </div>
    <div class="col-12 col-md-3 d-flex flex-column align-items-center">
      <div class="item">
        <p class="image">
          <img src="https://landen.imgix.net/uhtii1k9o5x3/assets/4n26c7rj.png?w=48" alt="<?= lg('merchandise.storage.page.advantage.delivery')?>" />
        </p>
        <h3 class="title"><?= lg('merchandise.storage.page.advantage.delivery')?></h3>
      </div>
    </div>
  </div>
</section>
...
<!-- //Services Section -->
 ...
 <!-- benefits-section-merchandise -->
<section class="benefits-section-merchandise">
  <div class="box">
    <div class="section">
      <div class="features">
        <div class="content-title">
          <h2 class="w3l-title-main mb-lg-4 mb-3"><?= lg('merchandise.storage.page.benefits.heading.title')?></h2>
        </div>


        <div class="content-subtitle">
          <p><?= lg('merchandise.storage.page.benefits.heading.subtitle')?></p>
        </div>
        ...
        <div class="feature">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.benefits.delivery.title')?></h3>
            <p><?= lg('merchandise.storage.page.benefits.delivery.subtitle')?></p>
          </div>
        </div>
        <div class="feature">
          <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.benefits.adaptive.title')?></h3>
            <p><?= lg('merchandise.storage.page.benefits.adaptive.subtitle')?></p>
          </div>
        </div>
        <div class="feature">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.benefits.inventory.title')?></h3>
            <p><?= lg('merchandise.storage.page.benefits.inventory.subtitle')?></p>
          </div>
        </div>
      </div>
      <img src="{{ asset('assets/img/merchandise-benefits.jpg') }}" alt="" class="left img-fluid rounded" />
    </div>
  </div>
</section>
<!-- benefits Section -->
 ...
 <!-- archiving-section -->
<section class="archiving-section-merchandise">
<br/>
 <br/>
  <div class="box">
    <div class="section">
      <img src="{{ asset('assets/img/merchandise-archiving.jpg')}}" alt="" class="img-fluid left" />

      <div class="features">

        <div class="content-title">
          <h2 class="w3l-title-main mb-lg-4 mb-3">
            <?= lg('merchandise.storage.page.archiving.heading.title')?>
          </h2>
        </div>
        ...
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.archiving.analysis.title')?></h3>
            <p><?= lg('merchandise.storage.page.archiving.analysis.subtitle')?></p>
          </div>
        </div>
        ...
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.archiving.boxes.title')?></h3>
            <p><?= lg('merchandise.storage.page.archiving.boxes.subtitle')?></p>
          </div>
        </div>
        ...
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.archiving.indexing.title')?></h3>
            <p><?= lg('merchandise.storage.page.archiving.indexing.subtitle')?></p>
          </div>
        </div>
      </div>
    </div>
...
<section class="service-section-merchandise">
  <div class="box">
    <div class="section">
      <div class="features">
        <div class="content-title">
          <h2 class="w3l-title-main mb-lg-4 mb-3"><?= lg('merchandise.storage.page.service.heading.title')?></h2>
        </div>
        <div class="content-subtitle">
          <h5><?= lg('merchandise.storage.page.service.heading.subtitle')?></h5>
        </div>
        <div class="feature">
        ...
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.service.solution.title')?></h3>
            <p><?= lg('merchandise.storage.page.service.solution.subtitle')?></p>
          </div>
        </div>
        <div class="feature">
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.service.collaborators.title')?></h3>
            <p><?= lg('merchandise.storage.page.service.collaborators-subtitle')?></p>
          </div>
        </div>
        <div class="feature">
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.service.discretion.title')?></h3>
            <p><?= lg('merchandise.storage.page.service.discretion.subtitle')?></p>
          </div>
        </div>
        <div class="feature">
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.service.logistic.title')?></h3>
            <p><?= lg('merchandise.storage.page.service.logistic.subtitle')?></p>
          </div>
        </div>
        ...
        <div class="circle">
          ...
          <div class="feature-info">
            <h3><?= lg('merchandise.storage.page.service.developing.title')?></h3>
            <p><?= lg('merchandise.storage.page.service.developing.subtitle')?></p>
          </div>
        </div>
      </div>
      <img src="{{ asset('assets/img/merchandise-service.jpg') }}" class="desktop"/>
 ...
 <section class="section-home-partners text-center">
        <div class="container">
			<h2><?= lg('merchandise.storage.page.partners.title')?></h2>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-2">
                           <label for="option_merchandise_pallet"><?= lg('merchandise.storage.page.form-section-title-choice')  ?></label>
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <label class="checkbox-inline">
                                <input type="checkbox" name="option_merchandise_pallet"
                                value="Yes"><?= lg('merchandise.storage.page.form-section-first-choice') ?>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <label class="checkbox-inline">
                                <input type="checkbox" name="option_bulk_merchandise"
                                value="Yes"><?= lg('merchandise.storage.page.form-section-second-choice') ?>
                        ...
                        <div class="col-xs-12 col-sm-2">
                            <label class="checkbox-inline">
                                ...
                                value="Yes"><?= lg('merchandise.storage.page.form-section-third-choice') ?>
                            </label>
                        </div>
