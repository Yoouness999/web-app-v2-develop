...
<head>
    <meta charset="utf-8">
    <title>{{ $headtitle ?: Config::get('project.name') }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="{{ $meta['description'] ?: Config::get('project.description') }}">
    <meta name="author" content="{{ $meta['author'] ?: Config::get('project.author') }}">
