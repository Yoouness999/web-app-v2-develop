...
class Arxmin extends \Arx\classes\Singleton
{
    ...
    public static function getWidgets()
    {
        return [
            [
                'name' => 'Lang Manager',
                'type' => 'iframe',
                'link' => url('/arxmin/dashboard/lang'),
            ],
        ];
    }
    ...
    public static function trans($id = null, $parameters = array(), $domain = 'messages', $locale = null)
    {
        ...
        if (is_string($parameters)) {
            $id = Arx\classes\Str::mustEndWith('.', $parameters) . $id;
            $parameters = [];
        }

        $result = trans($id, $parameters, $domain, $locale);
