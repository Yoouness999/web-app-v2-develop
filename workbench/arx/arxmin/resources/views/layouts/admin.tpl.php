                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                            ...
                            <img class="user-image" src="<?= $user->getGravatar() ?>" alt="<?= $user->first_name ?>"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img class="img-circle" src="<?= $user->getGravatar() ?>" alt="<?= $user->first_name ?>" />
                                <p>
                                    <?= $user->first_name ?>
                                </p>
                            </li>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-default btn-flat" href="<?= url('/arxmin/logout') ?>">Sign out</a>
                                </div>
                                @show
                            </li>
                        </ul>
